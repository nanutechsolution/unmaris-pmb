...
CREATE TABLE `pendaftars` (
  ...
  `status_ayah` enum('Hidup','Meninggal') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Hidup',
  ...
  `status_ibu` enum('Hidup','Meninggal') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Hidup',
  ...
  `pilihan_prodi_1` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
