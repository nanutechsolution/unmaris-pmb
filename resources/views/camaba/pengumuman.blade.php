    ...
    <div class="py-12 font-sans">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            @if ($pendaftar->status_pendaftaran == 'lulus')
                <div
                    class="bg-white border-4 border-unmaris-green shadow-neo-lg rounded-3xl p-8 md:p-12 text-center relative overflow-hidden animate-fade-in-up">
                    <!-- Confetti Decoration -->
                    ...
                    <div class="relative z-10">
                        <div
                            class="inline-block bg-unmaris-green text-white font-black text-xl px-4 py-1 transform -rotate-2 border-2 border-unmaris-blue shadow-neo mb-6">
                            🎉 PENGUMUMAN RESMI
                        </div>
                        ...
                        <p class="text-lg md:text-xl font-bold text-gray-600 mb-8 max-w-2xl mx-auto">
                            Selamat datang di keluarga besar <span class="text-unmaris-blue">Universitas Stella Maris
                                Sumba</span>. Perjalanan masa depanmu dimulai hari ini!
                        </p>
                        ...
                        <div class="flex flex-col md:flex-row justify-center gap-4">
                            ...
                            <a href="{{ route('camaba.pengumuman.cetak') }}"
                                class="bg-unmaris-yellow hover:bg-yellow-400 text-unmaris-blue font-black py-4 px-8 rounded-xl border-2 border-unmaris-blue shadow-neo hover:shadow-neo-hover hover:translate-x-[4px] hover:translate-y-[4px] transition-all flex items-center justify-center gap-2">
            ...
            @elseif($pendaftar->status_pendaftaran == 'gagal')
                <div class="bg-white border-4 border-gray-400 shadow-neo rounded-3xl p-12 text-center grayscale">
                    ...
                    <p class="text-lg font-bold text-gray-500 mb-6">
                        Berdasarkan hasil seleksi, Anda dinyatakan <span class="text-red-600 underline">TIDAK
                            LULUS</span> seleksi masuk UNMARIS tahun ini.
                    </p>
            ...
            @else
                <div class="bg-white border-4 border-unmaris-blue shadow-neo rounded-3xl p-12 text-center">
                    ...
                    <p
                        class="text-sm bg-yellow-100 inline-block px-3 py-1 rounded text-yellow-800 font-bold border border-yellow-300">
