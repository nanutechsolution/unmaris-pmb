<div class="min-h-screen bg-gray-50/50 pb-20 font-sans relative">
    ...
    <div x-data="{
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="bg-gray-900 text-white rounded-full shadow-2xl px-6 py-3 flex items-center justify-between gap-6 border border-gray-700/50 backdrop-blur-xl bg-opacity-95 flex-col sm:flex-row">
                    ...
                    <div class="flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-end">
                        ...
                        <div class="flex items-center gap-2 w-full sm:w-auto">
                            ...
                            <!-- TOMBOL CETAK MASSAL TAB BARU -->
                            <button x-data
                                x-on:click.prevent="
            let selectedIds = $wire.selected;
            ...
            // Buka tab baru
            window.open('{{ route('admin.pendaftar.cetak-massal') }}?ids=' + selectedIds.join(','), '_blank');
        "
                                class="flex-1 sm:flex-none inline-flex justify-center items-center gap-2 rounded-full bg-white/10 text-white border border-white/20 px-4 py-1.5 text-xs font-bold hover:bg-white hover:text-gray-900 transition disabled:opacity-50 cursor-pointer">
                                🖨️ Cetak Massal
                            </button>
