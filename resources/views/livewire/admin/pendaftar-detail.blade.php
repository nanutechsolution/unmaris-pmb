                            ...
                            <div class="group flex w-full items-center">
                                <span class="flex items-center px-6 py-4 text-sm font-medium">
                                    <span class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full transition-all {{ $status == 'complete' ? 'bg-green-500 shadow-md shadow-green-200' : ($status == 'current' ? 'border-2 border-indigo-600 bg-indigo-50' : 'border-2 border-gray-200 bg-gray-50') }}">
                                        @if($status == 'complete') <svg class="h-5 w-5 text-white" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
                    ...
                    <div class="bg-white shadow-sm border border-gray-200 rounded-2xl overflow-hidden transition-all duration-300">
                        ...
                        <div class="lg:hidden p-4 flex items-center justify-between cursor-pointer bg-white active:bg-gray-50 transition" @click="expandedProfile = !expandedProfile">
                            ...
                            <div class="bg-gray-50 p-2 rounded-xl text-gray-400 shrink-0 border border-gray-100">
                                <svg :class="expandedProfile ? 'rotate-180 text-indigo-600' : ''" class="w-4 h-4 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="lg:col-span-8">
                    <div class="bg-white shadow-sm border border-gray-200 rounded-2xl overflow-hidden min-h-[600px] flex flex-col relative z-10">
                        ...
                        <div class="px-4 py-4 sm:px-6 bg-white border-b border-gray-100 relative">
                            <div class="absolute right-0 top-0 bottom-0 w-8 bg-gradient-to-l from-white to-transparent z-10 pointer-events-none lg:hidden"></div>

                            <nav class="flex space-x-2 overflow-x-auto pb-2 scrollbar-hide snap-x w-full"
                                style="-webkit-overflow-scrolling: touch;"
                                x-ref="tabContainer">

                                <button @click="activeTab = 'berkas'; $nextTick(() => $el.scrollIntoView({behavior: 'smooth', block: 'nearest', inline: 'center'}))"
                                    ...
                                    class="snap-center shrink-0 px-4 py-2 rounded-xl text-sm font-black transition-all border">
                                    📂 Dokumen Berkas
                                </button>

                                <button @click="activeTab = 'biodata'; $nextTick(() => $el.scrollIntoView({behavior: 'smooth', block: 'nearest', inline: 'center'}))"
                                ...
                                <button @click="activeTab = 'akademik'; $nextTick(() => $el.scrollIntoView({behavior: 'smooth', block: 'nearest', inline: 'center'}))"
                                    ...
                                    class="snap-center shrink-0 px-4 py-2 rounded-xl text-sm font-black transition-all border flex items-center gap-2">
                                    📝 Nilai Akademik
                                    @if($pendaftar->nilai_ujian == 0) <span class="flex h-2.5 w-2.5 rounded-full bg-red-500 animate-pulse"></span> @endif
                                </button>

                                <button @click="activeTab = 'keuangan'; $nextTick(() => $el.scrollIntoView({behavior: 'smooth', block: 'nearest', inline: 'center'}))"
